...
export class ExecutionHandler {
     ...
     */
    async execute(code: string, language: string, webviewPanel: vscode.WebviewPanel, s3FilePath?: string, requirements?: string): Promise<void> {
     ...
     */
    private async executePython(code: string, webviewPanel: vscode.WebviewPanel, s3FilePath?: string, requirements?: string): Promise<void> {
        try {
            ...
            if (s3FilePath && requirements && requirements.trim()) {
                ...
                if (venvPath && fs.existsSync(venvPath)) {
                    ...
                    try {
                        ...
                        const successfulInstalls = lines.filter(line => 
