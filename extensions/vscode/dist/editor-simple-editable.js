...
exports.generateSimpleEditableHTML = generateSimpleEditableHTML;
function generateSimpleEditableHTML(document, webview, fontAwesomeUri, instructionsHtml, codeHtml, detectedLanguage, scriptUri) {
    ...
    // Escape requirements if they exist
    const escapedRequirements = escapeHtml(document.requirements || '');
    const isPythonFile = detectedLanguage === 'python' || detectedLanguage === 'py';
    const hasRequirements = document.requirements && document.requirements.trim() !== '';
...
<head>
    ...
    <style>
      ...
      /* Requirements Panel Styles - for Python files */
      .requirements-panel {
        background: var(--vscode-editor-background);
        border: 1px solid var(--vscode-panel-border);
        border-radius: 8px;
...
<body class="vscode-body">
    <div class="s3-container">
        <div class="button-group">
            <button class="ai-button" id="ai-button" title="Generate code with AI" style="display: inline-flex;">
                <i class="fas fa-hammer" id="ai-icon"></i>
    ...
    ${isPythonFile && hasRequirements ? `
    <!-- Requirements Panel (Python only, when requirements exist) -->
    <div class="requirements-panel" id="requirements-panel">
        <div class="requirements-header" id="requirements-header">
            <div class="requirements-title">
                <i class="fas fa-cube"></i>
                <span>Requirements</span>
            </div>
            <div class="output-controls">
                <button class="output-control-btn" id="toggle-requirements" title="Toggle Requirements">
                    <i class="fas fa-chevron-down" id="requirements-toggle-icon"></i>
                </button>
            </div>
        </div>
        <div class="requirements-content" id="requirements-content">
            <textarea 
                ...
                placeholder="Enter Python package requirements (one per line):\nExample:\nnumpy==1.24.3\npandas>=2.0.0\nmatplotlib"
            >${escapedRequirements}</textarea>
            <div class="requirements-help">
                Enter package requirements in pip format. A virtual environment will be created automatically when you run the code.
            </div>
        </div>
    </div>
    ` : ''}
...
//# sourceMappingURL=editor-simple-editable.js.map